      ...
      <div className="mx-auto max-w-6xl px-6 py-20 sm:py-28">
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2">
          {istatistikler.map((s, i) => (
            <Reveal key={s.baslik} delayMs={i * 100}>
              <div className="h-full rounded-[28px] border border-red-100 bg-red-50/60 p-8 text-center transition-all duration-300 ease-[var(--ease-apple)] hover:-translate-y-1 hover:shadow-xl hover:shadow-red-900/5 motion-reduce:transition-none motion-reduce:hover:translate-y-0">
